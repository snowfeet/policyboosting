...
public class TestPolicy {
    ...
    public static void run(int trial) throws Exception {
        ...
        double[][] resultsNPPG = exp.conductExperimentTrain(gbPolicy, task, 100, 50, initialState, maxStep, true, 0.1, new Random(random.nextInt()));
        ...
        IO.matrixWrite(resultsNPPG, "results/cw/NPPG_trial_" + trial + ".txt");
