...
public class TestPolicy {
    ...
    public static void run(int trial) throws Exception {
        ...
        double[][] resultsNPPG = exp.conductExperimentTrain(gbPolicy, task, 100, 30, initialState, maxStep, true, 0.1, new Random(random.nextInt()));
        ...
        IO.matrixWrite(resultsNPPG, "results/acrobot/NPPG_trial_" + trial + ".txt");
